...
describe("getTutorById should return tutor with given id arguement.", ()=>{
    it("should return the tutor of id = 1", ()=>{
        const tutor: Tutor = {
            id: 1, 
            created_at: "2024-10-17 13:14:19",
            full_name: "Emily Smith",
            email: "jane.smith@example.com",
            address: "456 Tutor St",
            postal_code: "54321",
            phone_number: "07700900002",
            description: "Hi! I’m Sarah and I’m so excited to start teaching Computer Science. I have a Master’s from MIT and like to sneak everywhere.",
            availability: null,
            fk_subject_id: null, 
